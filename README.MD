...
![alt text](app/src/docs/img/altausuario.png | width=50)
...
![alt text](/src/docs/img/altausuario.png)
...
> La misma puede anularse, eliminarse (mediante swipe) o modificarse.
